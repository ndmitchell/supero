...
\item Our case expression does not permit default alternatives. Defaults can be added easily, but aren't strictly needed, and we choose to omit them for simplicity.
\end{itemize}
